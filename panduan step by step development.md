...
1. submit issue dari file issue.md ke github lalu hapus file issue.md dari local (tampilkan perintah terminalnya)
...
7. buat pull request menggunakan github cli `gh pr create`, tampilkan perintah terminalnya
...
9. jika sudah approved dan merged, maka kembali ke main dan pull perubahan terbaru
10. hapus branch fitur atau perbaikan bug dari local
